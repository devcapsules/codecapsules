"""
SQL Judge Lambda Function - Supabase Read-Only Execution (API Gateway Compatible)
    ...
    try:
        ...
        if 'body' in event and isinstance(event['body'], str):
            try:
                ...
                user_sql = body.get('source_code', '').strip()
                timeout_seconds = min(body.get('timeout', 30), 60)  # Max 60 seconds
