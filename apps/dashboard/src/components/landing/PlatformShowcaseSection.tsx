      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
            Embed Interactive Code <span className="text-[#00ff87]">Anywhere</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
          {/* Content Platforms */}
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-center hover:border-[#00ff87]/50 transition-all">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          <div className="bg-gradient-to-r from-[#00ff87]/10 to-emerald-500/10 border border-[#00ff87]/30 rounded-xl p-6 text-center">
