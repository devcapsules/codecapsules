...
const DOCUMENT_TABS = [
  { id: 'problem', name: 'Problem', icon: DocumentTextIcon, color: 'text-blue-400', extension: '.md' },
  { id: 'code', name: 'Starter Code', icon: CodeBracketIcon, color: 'text-green-400', extension: '.js' },
  { id: 'solution', name: 'Solution', icon: CheckCircleIcon, color: 'text-purple-400', extension: '.js' },
  { id: 'hints', name: 'Hints', icon: LightBulbIcon, color: 'text-yellow-400', extension: '.md' },
  { id: 'tests', name: 'Tests', icon: BeakerIcon, color: 'text-red-400', extension: '.js' }
];
    ...
    <>
      <div className="h-screen flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="hidden lg:flex flex-1">
            ...
            {!isLeftPanelCollapsed && (
              <div className="flex-1 p-6 overflow-y-auto">
                <div className="space-y-8">
                  {/* Capsule Type Selection */}
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-4">Capsule Type</label>
                    <div className="grid grid-cols-1 gap-3">
                      {CAPSULE_TYPES.map((type) => {
                        ...
                        return (
                          ...
                          >
                            <Icon className={`h-6 w-6 ${selectedType === type.id ? 'text-blue-400' : type.color}`} />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, prompt: e.target.value }))}
                      placeholder="Describe what you want to create..."
                      className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-lg text-white placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
                      rows={5}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        value={config.language}
                        onChange={(e) => setConfig(prev => ({ ...prev, language: e.target.value }))}
                        className="w-full px-3 py-2 bg-gray-800/50 border border-gray-600/50 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                      >
                        <option value="JavaScript">JavaScript</option>
                        <option value="Python">Python</option>
                        <option value="Java">Java</option>
                  ...
                  {/* Options */}
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-4">Generation Options</label>
                    <div className="space-y-4">
                      {[
                        { key: 'includeTestCases', label: 'Generate Test Cases', checked: config.includeTestCases },
                        { key: 'includeHints', label: 'Generate Hints', checked: config.includeHints },
                  ...
                  <div className="space-y-4">
                    <button
                      ...
                      disabled={!selectedType || !config.prompt.trim() || generationState.isGenerating}
                      className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors"
                    >
                      {generationState.isGenerating ? (
                        <>
          ...
          <div className="flex-1 bg-gray-800/30 flex flex-col min-w-0">
            {/* Document Tabs Bar */}
            <div className="border-b border-gray-700/50 bg-gray-900/30">
              <div className="flex items-center">
                {generationState.generatedContent ? (
                    ...
                    {DOCUMENT_TABS.map((tab) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center space-x-2 px-4 py-2 text-sm border-r border-gray-700/50 transition-colors ${
                            isActive 
                        ...
                        >
                          ...
                          {isActive && (
                            <div className="w-1.5 h-1.5 bg-blue-400 rounded-full ml-1"></div>
                          )}
                        </button>
                      );
                    })}
                  ...
                  <div className="flex items-center space-x-2 px-4 py-2 bg-gray-800/50 text-gray-400">
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              {generationState.error ? (
                ...
                <div className="space-y-6">
                  {/* Edit Mode Header */}
                  {isEditMode && (
                    <div className="flex items-center justify-between bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
                      <span className="text-yellow-300 text-sm font-medium">Editing Mode</span>
                      <div className="flex items-center space-x-3">
                        <button
                ...
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
                    ...
                    <span>Ready to generate amazing content</span>
                  </div>
                </div>
              )}
            </div>
