          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                disabled={loading}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-600/50 rounded-lg shadow-sm bg-gray-700/50 text-sm font-medium text-gray-300 hover:bg-gray-600/50 disabled:opacity-50"
              >
