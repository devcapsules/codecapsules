...
export default function LearnCapsulesCatalog() {
  ...
  return (
    <>
      <Head>
        <title>Interactive Code Exercises — DevCapsules</title>
        <meta name="description" content="Browse interactive coding exercises powered by DevCapsules. Embeddable, runnable, and self-validating code challenges." />
      </Head>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold">
              Interactive <span style={{ color: '#00ff87' }}>Code Exercises</span> That Run Anywhere
            </h2>
            <p className="text-slate-400 text-lg">
              Embeddable coding challenges with instant execution, test validation, and real-time feedback — built for docs, tutorials, and technical content.
            </p>
            <p className="text-slate-500 text-sm">
              Browse our <span className="text-slate-300">demo courses</span> to see what DevCapsules can do.
            </p>
          </div>
        </section>
